...
import CreateUpdateCategoryForm from "./addCategoryForm";
  ...
  return (
    <div className="py-0 flex items-center justify-center">
      ...
      <Modal
        ...
        onClose={handleClose}
        title={`Ajouter une 
        <span class="px-2 py-1 rounded-md bg-gray-100 text-gray-700 text-sm">Category </span>`}
      >
        <CreateUpdateCategoryForm onCancel={handleClose} />
      </Modal>
    </div>
  );
}
