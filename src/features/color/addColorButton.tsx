...
import CreateUpdateColorForm from "./addColorForm";

interface AddColorButtonProps {
  onClick?: () => void;
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function AddColorButton({ onClick }: AddColorButtonProps) {
  ...
  return (
    <div className="py-0 flex items-center justify-center">
      ...
      <Modal
        ...
        onClose={handleClose}
        title={`Ajouter une  
        <span class="px-2 py-1 rounded-md bg-gray-100 text-gray-700 text-sm">Couleur</span>`}
      >
        <CreateUpdateColorForm onCancel={handleClose} />
      </Modal>
    </div>
  );
}
