...
export function AddSupplierButton({ onClick }: AddSupplierButtonProps) {
  ...
  return (
    <div className="py-0 flex items-center justify-center">
      ...
      <Modal
        ...
        maxWidth="max-w-md"
        title={`Ajouter une  
        <span class="px-2 py-1 rounded-md bg-gray-100 text-gray-700 text-sm">Fournisseur</span>`}
      >
        <CreateUpdateDepotForm onCancel={handleClose} />
      </Modal>
    </div>
  );
}
