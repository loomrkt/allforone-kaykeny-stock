...
import CreateUpdateSizeForm from "./addSizeForm";

interface AddSizeButtonProps {
  onClick?: () => void;
}
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export function AddSizeButton({ onClick }: AddSizeButtonProps) {
  ...
  return (
    <div className="py-0 flex items-center justify-center">
      ...
      <Modal
        ...
        onClose={handleClose}
        title={`Ajouter une  
        <span class="px-2 py-1 rounded-md bg-gray-100 text-gray-700 text-sm">Taille</span>`}
      >
        <CreateUpdateSizeForm onCancel={handleClose} />
      </Modal>
    </div>
  );
}
