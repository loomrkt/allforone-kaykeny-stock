...
export function UserGrid({
  ...
  return (
    <div className="sm:hidden block space-y-4 px-4 w-full  h-[78vh] overflow-y-auto">
      {userData.map((user: User) => (
        <div
          key={user.id}
          role="button"
          tabIndex={0}
          className="bg-white shadow-md rounded-xl p-4 border border-gray-100 cursor-pointer hover:shadow-xl hover:bg-gray-50 transition-shadow duration-200"
      ...
      <div
        className="mt-6 flex justify-center 
             md:static md:mt-6 
             fixed bottom-4 right-4 z-10 bg-white p-2 rounded shadow-md"
      >
        <Pagination
